...
- should stay markup-compatible with the main product grid in `templates/products.liquid`
...
- Any markup change to product cards should be checked both here and in `templates/products.liquid`.
